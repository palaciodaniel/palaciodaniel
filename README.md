...
**Showcased Skills:** Python (pandas, numpy, *Dataset Creation (CSV)*, *Data Cleaning*, *Data Visualization* -matplotlib, seaborn, GeoPandas-, *Unit Testing* -pytest-, *API Requesting* -requests-, *Machine Learning* -scikit learn-, *Web Scraping* -scrapy-, Faker, fuzzy-wuzzy, *Natural Language Processing* -nltk, WordCloud-), SQL (ipython-sql), Bash, Spreadsheets, Julia
